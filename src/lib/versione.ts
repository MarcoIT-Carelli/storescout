...
export const NOVITA: Record<string, string[]> = {
  '1.2.2': [
    'La tastiera non copre più i campi in nessuna schermata: scheda, firme, cambio password e pannello di amministrazione si spostano per farle posto.',
  ],
  '1.2.1': [
    'Sull’accesso la tastiera non copre più la password: la schermata le fa posto sul serio, e trascinando non si chiude più.',
  ],
  '1.2.0': [
    'Con il tablet in orizzontale la tastiera non copre più il campo della password: la schermata di accesso si sposta per lasciarlo in vista.',
    'In «Ispezioni ed export» i filtri sono chiusi: si aprono dal pulsante «Filtri», e l’elenco delle ispezioni si vede tutto.',
  ],
  '1.1.9': [
    'I messaggi che elencano cosa manca in un’attività ora sono scritti bene: prima diceva «manca il scadenza».',
    'Nel riepilogo un indirizzo email non compare più due volte quando l’ufficio e l’ispettore hanno la stessa casella.',
  ],
  '1.1.8': [
    'Le foto si riaprono anche dopo un po’ che la scheda è a schermo: prima la seconda apertura dava errore.',
    'La chiusura dell’ispezione è più rapida: l’app non prepara più copie per gli uffici che non hanno un indirizzo email, perché nessuno le riceverebbe.',
  ],
  '1.1.7': [
    'Aprendo una scheda «da chiudere» vedi subito le sole attività da verificare, senza cercarle in mezzo alle altre.',
    'Il pulsante in fondo mostra tutta la scheda quando ti serve, e la riporta al solo essenziale.',
  ],
  '1.1.6': [
    'Il voto si chiama ora «Voto ispezione», nella scheda e nel PDF.',
  ],
  '1.1.5': [
    'Chi riceve una password nuova dall’amministratore ora la cambia una volta sola: prima l’app continuava a richiederla a ogni avvio.',
  ],
  '1.1.4': [
    'Quando il salvataggio di un file non riesce, l’app spiega che cosa è successo invece di mostrare il messaggio tecnico del server.',
  ],
  '1.1.3': [
